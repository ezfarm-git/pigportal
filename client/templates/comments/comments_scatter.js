Template.comments_scatter.onCreated(function () {
  this.selectedDoc = new ReactiveVar("");
  this.formType = new ReactiveVar("insert");
  this.askPass = new ReactiveVar(false);
});

Template.comments_scatter.onDestroyed(function () {
...
Template.comments_scatter.helpers({
  comments: function () {
...
Template.comments_scatter.events({
