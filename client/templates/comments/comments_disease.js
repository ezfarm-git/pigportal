Template.comments_disease.onCreated(function () {
  this.selectedDoc = new ReactiveVar("");
  this.formType = new ReactiveVar("insert");
  this.askPass = new ReactiveVar(false);
});

Template.comments_disease.onDestroyed(function () {
...
Template.comments_disease.helpers({
  comments: function () {
...
Template.comments_disease.events({
