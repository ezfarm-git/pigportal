    ...
    Meteor.call('market.get', start, end, skin, sex, function (error, result) {
      if (error) {
        ...
        for (i = 0; i < st.item.length; i++) {
          ...
          } else if (marketData.response.body[0].items[0].item[i].gradeNm.toString() === '1') {
            PNC = {
              "BK_Amt": "",
              "BK_Cnt": "",
              "HS_Amt": "",
          ...
          } else if (marketData.response.body[0].items[0].item[i].gradeNm.toString() === '2') {
            PNC = {
              "BK_Amt": "",
              "BK_Cnt": "",
              "HS_Amt": "",
          ...
          } else if (marketData.response.body[0].items[0].item[i].gradeNm.toString() === '등외') {
            PNC = {
              "BK_Amt": "",
              "BK_Cnt": "",
              "HS_Amt": "",
          ...
          } else if (marketData.response.body[0].items[0].item[i].gradeNm.toString() === '등외제외') {
            PNC = {
              "BK_Amt": "",
              "BK_Cnt": "",
              "HS_Amt": "",
          ...
          } else if (marketData.response.body[0].items[0].item[i].gradeNm.toString() === '모돈') {
            PNC = {
              "BK_Amt": "",
              "BK_Cnt": "",
              "HS_Amt": "",
