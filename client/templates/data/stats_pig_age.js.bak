    ...
    function drawPlot(curCity) {
        ...
        $.each(series, function(i, val) {
            if (series[i].attributes[0].value === "Q" && series[i].attributes[1].value === "T01" && series[i].attributes[2].value === currnet_City &&
                series[i].attributes[3].value === "14STD04410") {
                $.each(series[i].childNodes, function(iv, val) {
                    time[iv] = series[i].childNodes[iv].attributes[1].value;
                    age_total[iv] = series[i].childNodes[iv].attributes[0].value;
                });
            } else if (series[i].attributes[0].value === "Q" && series[i].attributes[1].value === "T02" && series[i].attributes[2].value === currnet_City &&
                series[i].attributes[3].value === "14STD04410") {
                $.each(series[i].childNodes, function(iv, val) {
                    age_under_2_total[iv] = series[i].childNodes[iv].attributes[0].value;
                });
            } else if (series[i].attributes[0].value === "Q" && series[i].attributes[1].value === "T03" && series[i].attributes[2].value === currnet_City &&
                series[i].attributes[3].value === "14STD04410") {
                $.each(series[i].childNodes, function(iv, val) {
                    age_2_4_total[iv] = series[i].childNodes[iv].attributes[0].value;
                });
            } else if (series[i].attributes[0].value === "Q" && series[i].attributes[1].value === "T04" && series[i].attributes[2].value === currnet_City &&
                series[i].attributes[3].value === "14STD04410") {
                $.each(series[i].childNodes, function(iv, val) {
                    age_4_6_total[iv] = series[i].childNodes[iv].attributes[0].value;
                });
            } else if (series[i].attributes[0].value === "Q" && series[i].attributes[1].value === "T06" && series[i].attributes[2].value === currnet_City &&
                series[i].attributes[3].value === "14STD04410") {
                $.each(series[i].childNodes, function(iv, val) {
                    age_6_8_female[iv] = series[i].childNodes[iv].attributes[0].value;
                });
            } else if (series[i].attributes[0].value === "Q" && series[i].attributes[1].value === "T07" && series[i].attributes[2].value === currnet_City &&
                series[i].attributes[3].value === "14STD04410") {
                $.each(series[i].childNodes, function(iv, val) {
                    age_6_8_male[iv] = series[i].childNodes[iv].attributes[0].value;
                });
            } else if (series[i].attributes[0].value === "Q" && series[i].attributes[1].value === "T09" && series[i].attributes[2].value === currnet_City &&
                series[i].attributes[3].value === "14STD04410") {
                $.each(series[i].childNodes, function(iv, val) {

                    age_over_8_female[iv] = series[i].childNodes[iv].attributes[0].value;
                });
            } else if (series[i].attributes[0].value === "Q" && series[i].attributes[1].value === "T10" && series[i].attributes[2].value === currnet_City &&
                series[i].attributes[3].value === "14STD04410") {
                $.each(series[i].childNodes, function(iv, val) {
                    age_over_8_male[iv] = series[i].childNodes[iv].attributes[0].value;
                });
            }
