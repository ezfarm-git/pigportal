Template.case_admin.onCreated(function() {
    this.selectedDoc = new ReactiveVar("");
    this.selectedImage = new ReactiveVar("");
    this.formType = new ReactiveVar("insert");
});

Template.case_admin.onDestroyed(function() {
...
Template.case_admin.helpers({
    ...
    selectedDoc: function() {
        return Case.findOne(Template.instance().selectedDoc.get());
    },
...
Template.case_admin.events({
    ...
    'click .remove-btn': function(evt, tmpl) {
        ...
        Meteor.call('Case.remove', postId);
